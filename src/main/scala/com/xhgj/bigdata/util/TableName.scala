...
object TableName {
  ...
  val ODS_ERP_MATERIALBASE_DA=ODS+"ODS_ERP_MATERIALBASE_DA"
  ...
  val ODS_ERP_MRB_DA=ODS+"ODS_ERP_MRB_DA"
  val ODS_ERP_MRBENTRY_DA=ODS+"ODS_ERP_MRBENTRY_DA"
  val ODS_ERP_MRBFIN_DA=ODS+"ODS_ERP_MRBFIN_DA"
  val ODS_ERP_MRBENTRY_F_DA=ODS+"ODS_ERP_MRBENTRY_F_DA"
  val ODS_ERP_MRBENTRY_LK_DA=ODS+"ODS_ERP_MRBENTRY_LK_DA"
  val ODS_ERP_INVENTORY_DA=ODS+"ODS_ERP_INVENTORY_DA"
  val ODS_ERP_RESERVELINKENTRY_DA=ODS+"ODS_ERP_RESERVELINKENTRY_DA"
  ...
  val ODS_ERP_INSTOCKFIN=ODS+"ODS_ERP_INSTOCKFIN"
  ...
  val ODS_ERP_ASSEMBLY_DA=ODS+"ODS_ERP_ASSEMBLY_DA"
  val ODS_ERP_ASSEMBLYPRODUCT_DA=ODS+"ODS_ERP_ASSEMBLYPRODUCT_DA"
  val ODS_ERP_ASSEMBLYSUBITEM_DA=ODS+"ODS_ERP_ASSEMBLYSUBITEM_DA"
  val ODS_ERP_OUTSTOCK=ODS+"ODS_ERP_OUTSTOCK"
  val ODS_ERP_OUTSTOCKFIN=ODS+"ODS_ERP_OUTSTOCKFIN"
  ...
  val ODS_ERP_STKTRANSFERIN_DA=ODS+"ODS_ERP_STKTRANSFERIN_DA"
  val ODS_ERP_STKTRANSFERINENTRY_DA=ODS+"ODS_ERP_STKTRANSFERINENTRY_DA"
  val ODS_ERP_STKCOUNTLOSS_DA=ODS+"ODS_ERP_STKCOUNTLOSS_DA"
  val ODS_ERP_STKCOUNTLOSSENTRY_DA=ODS+"ODS_ERP_STKCOUNTLOSSENTRY_DA"
  val ODS_ERP_STKCOUNTGAIN_DA=ODS+"ODS_ERP_STKCOUNTGAIN_DA"
  val ODS_ERP_STKINVINIT_DA=ODS+"ODS_ERP_STKINVINIT_DA"
  val ODS_ERP_STKINVINITDETAIL_DA=ODS+"ODS_ERP_STKINVINITDETAIL_DA"
  val ODS_ERP_STKCOUNTGAINENTRY_DA=ODS+"ODS_ERP_STKCOUNTGAINENTRY_DA"
  val ODS_ERP_ARSETTLEMENT=ODS+"ODS_ERP_ARSETTLEMENT"
  val ODS_ERP_ARSETTLEMENTDETAIL=ODS+"ODS_ERP_ARSETTLEMENTDETAIL"
  val ODS_ERP_MATERIALSTOCK_DA=ODS+"ODS_ERP_MATERIALSTOCK_DA"
  ...
  val ODS_EAS_ASSISTBALANCE = ODS+"ODS_EAS_ASSISTBALANCE"
  val ODS_ERP_RETURNSTOCK = ODS+"ODS_ERP_RETURNSTOCK"
  val ODS_ERP_RETURNSTOCKFIN = ODS+"ODS_ERP_RETURNSTOCKFIN"
  val ODS_ERP_RETURNSTOCKENTRY_F = ODS+"ODS_ERP_RETURNSTOCKENTRY_F"
  val ODS_ERP_RETURNSTOCKENTRY_R = ODS+"ODS_ERP_RETURNSTOCKENTRY_R"
  val ODS_ERP_RETURNSTOCKENTRY = ODS+"ODS_ERP_RETURNSTOCKENTRY"
  //ODS层其他表
  val ODS_ERP_SALORDERENTRY_F=ODS+"ODS_ERP_SALORDERENTRY_F"
  val ODS_OMS_PFORDER=ODS+"ODS_OMS_PFORDER"
  val ODS_OMS_PFRETURNORDER=ODS+"ODS_OMS_PFRETURNORDER"
  val ODS_OMS_PFRETURNORDERDETAIL=ODS+"ODS_OMS_PFRETURNORDERDETAIL"
  ...
  val ODS_ERP_BigTicketProjectEntry=ODS+"ODS_ERP_BigTicketProjectEntry"
  //ODS层维度表
  ...
  val DWS_STATUS_PAYAMOUNT=DW+"DWS_STATUS_PAYAMOUNT"
  val DWS_STATUS_INVOICING=DW+"DWS_STATUS_INVOICING"
  val DWD_WRITE_PFORDER=DW+"DWD_WRITE_PFORDER"
  ...
  val DWD_HISTORY_RECEIVABLEENTRY=DW+"DWD_HISTORY_RECEIVABLEENTRY"
